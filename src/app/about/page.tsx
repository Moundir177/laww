  ...
  return (
    <div>
      ...
      <section className="py-16 bg-white overflow-hidden relative">
        {/* Background decorative elements */}
        <motion.div 
          className="absolute top-20 left-0 w-64 h-64 bg-teal-500/5 rounded-full blur-3xl"
          animate={{ 
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3] 
          }}
        ...
        />
        <motion.div 
          className="absolute bottom-40 right-0 w-96 h-96 bg-orange-500/5 rounded-full blur-3xl"
          animate={{ 
            scale: [1.2, 1, 1.2],
            opacity: [0.2, 0.4, 0.2] 
          }}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-teal-500 via-yellow-500 to-orange-500 rounded-full"></div>
            
            {/* Février 2024 - Création officielle */}
            <motion.div 
            ...
            >
              <div className="relative flex items-center justify-center mb-6">
                <motion.div 
                  className="absolute w-full h-0.5 bg-gradient-to-r from-transparent via-teal-500 to-transparent"
                  initial={{ scaleX: 0 }}
                ...
                ></motion.div>
                <motion.div 
                  className="bg-teal-500 text-white font-semibold py-2 px-8 rounded-full z-10 shadow-lg flex items-center space-x-2"
                ...
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M3 8.5C3 5.5 4.5 4 7.5 4H16.5C19.5 4 21 5.5 21 8.5V17.5C21 20.5 19.5 22 16.5 22H7.5C4.5 22 3 20.5 3 17.5V8.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
                  <span>{language === 'fr' ? 'Février 2024' : 'فبراير 2024'}</span>
                </motion.div>
              </div>
              ...
              >
                <div className="md:w-1/2 flex justify-end pr-8 md:pr-12">
                  <div className="w-4 h-4 rounded-full bg-teal-500 border-4 border-white shadow-md mt-2 md:mr-[-1.75rem] z-10"></div>
                </div>
                <div className="md:w-1/2 pl-8 md:pl-12">
                  <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-t-4 border-teal-500">
            ...
            {/* Mars 2024 - Notre équipe diverse */}
            <motion.div 
              className="relative z-10 mb-16"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="relative flex items-center justify-center mb-6">
                ...
                ></motion.div>
                <motion.div 
                  className="bg-yellow-500 text-white font-semibold py-2 px-8 rounded-full z-10 shadow-lg flex items-center space-x-2"
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 400, damping: 10 }}
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>{language === 'fr' ? 'Mars 2024' : 'مارس 2024'}</span>
                </motion.div>
              </div>
              ...
              <motion.div 
                ...
                transition={{ duration: 0.6, delay: 0.3 }}
              >
                <div className="md:w-1/2 flex justify-end pr-8 md:pr-12 md:order-2">
                  <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-t-4 border-yellow-500">
                ...
                <div className="md:w-1/2 flex justify-start pl-8 md:pl-12 md:order-1">
                  <div className="w-4 h-4 rounded-full bg-yellow-500 border-4 border-white shadow-md mt-2 md:ml-[-1.75rem] z-10"></div>
                </div>
              </motion.div>
            </motion.div>
            
            {/* Mars 2024 (continued) - Premier programme de formation */}
            <motion.div 
              className="relative z-10 mb-16"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <div className="md:w-1/2 flex justify-end pr-8 md:pr-12">
                  <div className="w-4 h-4 rounded-full bg-yellow-500 border-4 border-white shadow-md mt-2 md:mr-[-1.75rem] z-10"></div>
                </div>
                <div className="md:w-1/2 pl-8 md:pl-12">
                  <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-t-4 border-yellow-500">
                    <h3 className="text-2xl font-bold text-yellow-600 mb-3">
            ...
            {/* Avril 2024 - Premier partenariat international */}
            <motion.div 
              className="relative z-10 mb-16"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="relative flex items-center justify-center mb-6">
                <motion.div 
                  className="absolute w-full h-0.5 bg-gradient-to-r from-transparent via-orange-500 to-transparent"
                  initial={{ scaleX: 0 }}
                  whileInView={{ scaleX: 1 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.8, delay: 0.2 }}
                ></motion.div>
                <motion.div 
                  className="bg-orange-500 text-white font-semibold py-2 px-8 rounded-full z-10 shadow-lg flex items-center space-x-2"
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 400, damping: 10 }}
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>{language === 'fr' ? 'Avril 2024' : 'أبريل 2024'}</span>
                </motion.div>
              </div>
              ...
              >
                <div className="md:w-1/2 flex justify-end pr-8 md:pr-12 md:order-2">
                  <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-t-4 border-orange-500">
                ...
                <div className="md:w-1/2 flex justify-start pl-8 md:pl-12 md:order-1">
                  <div className="w-4 h-4 rounded-full bg-orange-500 border-4 border-white shadow-md mt-2 md:ml-[-1.75rem] z-10"></div>
                </div>
              </motion.div>
            </motion.div>
            
            {/* Juin 2024 - Lancement du site web */}
            <motion.div 
              className="relative z-10 mb-16"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="relative flex items-center justify-center mb-6">
                ...
                >
                  ...
                  <span>{language === 'fr' ? 'Juin 2024' : 'يونيو 2024'}</span>
                </motion.div>
              </div>
            ...
            >
              <motion.div 
                ...
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-xl border-2 border-dashed border-gray-300 shadow-md max-w-md">
